...
// 🚀 INITIALIZE APP FIRST (Fixes the ReferenceError)
const app = express();
...
app.get('/admin', requireAuth, async (req, res) => {
  try {
    const messagesResult = await pool.query('SELECT id, name, email, message FROM contact_messages ORDER BY id DESC');
  ...
  try {
    ...
    return res.send(`
      <div style="font-family: sans-serif; background-color: #0f172a; color: white; height: 100vh; display: flex; flex-direction: column; justify-content: center; align-items: center;">
        ...
        <p style="color: #94a3b8; margin-bottom: 20px;">A recovery message has been initialized for ${email}.</p>
...
// 📨 Post Channel: Sync Contact Box Submissions with Neon
