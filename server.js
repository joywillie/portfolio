...
const pool = new Pool({
    ...
    // Automatically enforces SSL mode when deployed live on Render
...
// 🎨 Login view template path routing with helper hint text built-in
    ...
    res.send(`
        <body style="background:#0f172a; color:white; font-family:sans-serif; display:flex; flex-direction:column; justify-content:center; align-items:center; height:100vh; margin:0; padding: 20px;">
            ...
            <form action="/api/admin/login" method="POST" style="background:#1e293b; padding:40px; border-radius:12px; display:flex; flex-direction:column; gap:20px; width:100%; max-width:360px; border:1px solid #334155; box-shadow: 0 10px 25px rgba(0,0,0,0.3);">
                ...
                <div style="background: rgba(56, 189, 248, 0.1); border: 1px dashed #38bdf8; padding: 14px; border-radius: 6px; font-size: 13px; color: #cbd5e1; line-height: 1.5;">
                    <strong style="color: #38bdf8; display: block; margin-bottom: 6px;">🔐 Master System Credentials:</strong>
                    <strong>Email:</strong> admin@joytech.com<br>
                    <strong>Password:</strong> admin2026
                </div>

                <div style="display: flex; flex-direction: column; gap: 5px;">
                    <label style="font-size: 14px; color: #94a3b8;">Email Address</label>
                    <input type="email" name="email" placeholder="admin@joytech.com" required style="padding:14px; background:#0f172a; border:1px solid #334155; color:white; border-radius:6px; outline:none; font-size: 15px;">
                </div>

                <div style="display: flex; flex-direction: column; gap: 5px;">
                    <label style="font-size: 14px; color: #94a3b8;">Master Password</label>
                    <input type="password" name="password" placeholder="••••••••" required style="padding:14px; background:#0f172a; border:1px solid #334155; color:white; border-radius:6px; outline:none; font-size: 15px;">
                </div>

                <button type="submit" style="background:#38bdf8; color:#0f172a; border:none; padding:14px; font-weight:bold; border-radius:6px; cursor:pointer; font-size: 16px; margin-top: 10px; transition: background 0.2s;">Authenticate</button>
            </form>
